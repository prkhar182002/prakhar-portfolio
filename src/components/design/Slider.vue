...
<script setup lang="ts">
  ...
  const people = [
    {
      quote:
        'Working with Prakhar has been an exceptional experience. His creative approach to development and keen eye for design consistently delivers outstanding results that exceed expectations.',
    ...
    {
      quote:
        'Working with Prakhar on the Axon website has been an exceptional experience. His invaluable support and dedication were crucial in bringing this project to life. Thank you, Prakhar!',
      author: 'Esmail Atta',
