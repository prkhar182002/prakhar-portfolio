<template>
  <section
    id="about-me-section"
    class="common-padding text-flax-smoke-100 relative z-10 overflow-y-clip rounded-b-3xl bg-flax-smoke-900 shadow-2xl will-change-auto sm:mt-0"
  >
    ...
    <div class="padding-y md:column-gap mt-6 grid grid-cols-12">
      ...
      <div class="col-span-11 mt-10 md:col-span-8 md:col-start-6">
        ...
        >
          I'm a full-stack developer specializing in web and mobile application development. I build scalable solutions using React, Next.js, Vue.js for web, and native iOS apps, backed by robust databases and cloud infrastructure.
        </p>
        ...
        >
          ...
          <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
            With expertise spanning modern web frameworks (React, Next.js, Vue.js), iOS development, database design (MongoDB, SQL), and cloud deployment (AWS), I deliver end-to-end solutions. <br /><br />
            I focus on writing clean, maintainable code, implementing best practices in DevOps, and ensuring applications are scalable, secure, and performant. Whether it's a responsive web app, a native iOS application, or cloud infrastructure setup, I bring technical excellence to every project.
          </p>
        </div>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  onBeforeMount(() => {
    aboutMe.value = textSplitterIntoChar(
      'Full-Stack Developer, iOS Developer, Cloud Engineer/',
      true,
      true,
    );
  });
