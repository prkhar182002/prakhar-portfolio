            ...
            <div class="relative origin-left overflow-hidden sm:scale-150">
              <div id="contact-btn" class="flex -translate-y-full">
                <!-- <Button
                  ...
                  label="Get in touch"
                /> -->
                <Button label="Get in touch" url="mailto:RAJPUTPRAKHAR182002@GMAIL.COM" />
              </div>
            </div>
          </div>
...
<script setup lang="ts">
  ...
  const whoAmI = ref(
    'Full-stack developer & iOS app creator. I build scalable web applications with React, Next.js, and Vue.js, develop native iOS apps, and deploy robust solutions on AWS cloud infrastructure.',
  );
