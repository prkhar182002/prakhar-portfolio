  ...
  <section id="works" class="common-padding mb-20">
    <div class="flex flex-col">
      ...
      >
        ...
        >
          Featured projects showcasing full-stack web applications, iOS apps, and cloud-deployed solutions built with modern technologies.
        </p>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  const selectedWorksProps = [
    ...
    {
      name: 'Cloud-Based Analytics Platform',
      category: 'Full-Stack & DevOps',
      tags: ['Vue.js', 'AWS', 'Docker'],
      videoSrc: work4,
      imageBg: workBg4,
      url: '#',
      year: '2023',
